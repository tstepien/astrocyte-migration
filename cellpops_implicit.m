function [c1_new,c2_new,eta_fraction] = cellpops_implicit(j,c1_old,c2_old,p1,p2,...
    dt,r,kappa,mu,alpha1,alpha2,beta,gamma1,gamma2,cmin,rbar,ce,tcurr)
...
maindiag22 = [1-theta2_4 , 1-theta2_2 , 1];%theta5];
