function [c1_new,c2_new] = cellpopulations_may14(j,c1_old,c2_old,PO2,dt,r,Pm,...
...
upperdiag11 = [theta1_4 , ...
    theta1_1];
maindiag11 = [1 - dt*g11(1) - theta1_4 , ...
    1 - dt*g11(2:j) - theta1_2 , ...
    1 - dt*g11(j+1)];
...
upperdiag22 = [theta2_4 , ...
    theta2_1];
maindiag22 = [1 - dt*g22(1) - theta2_4 , ...
    1 - dt*g22(2:j) - theta2_2 , ...
    1 - dt*g22(j+1)];
